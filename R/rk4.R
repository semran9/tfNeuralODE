...
#   k1 <- list(1.0, func(state))
#   k2 <- list(1.0, func(euler_update(h_list = state, dh_list = k1, dt / 2)))
#   k3 = list(1.0, func(euler_update(state, k2, dt / 2)))
#   k4 = list(1.0, func(euler_update(state, k3, dt)))
#   output = list()
...
# Original Implementation, with non-custom keras model
