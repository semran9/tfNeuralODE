...
Please note that in its current state, tfNeuralODE is in not an optimized state, with programs running quite slowly at the moment. Improvements to speed are a priority on the development agenda.
